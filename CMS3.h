...
protected: 
	...
	vector<float> pfjets_puppi_pfCombinedMVAV2BJetTags_;
	TBranch *pfjets_puppi_pfCombinedMVAV2BJetTags_branch;
	bool pfjets_puppi_pfCombinedMVAV2BJetTags_isLoaded;
...
void LoadAllBranches(); 
	...
	const vector<float> &pfjets_puppi_pfCombinedMVAV2BJetTags();

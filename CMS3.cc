...
namespace tas {
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &genjets_p4() { return cms3.genjets_p4(); }
	...
	const unsigned int &evt_ngenjets() { return cms3.evt_ngenjets(); }
